...
# select these routes
selectRoutes=("704","705","710","720","728","733","734","740","744","745","750","751","754","757","760","762","770","780","788","794")
...
# get agency name(s)
gtfs_agencyfile="metro_bus/agency.txt"
...
gtfs_routesfile="metro_bus/routes.txt"
...
gtfs_tripsfile="metro_bus/trips.txt"
...
gtfs_stop_timesfile="metro_bus/stop_times.txt"
...
# name stops
gtfs_stopsfile="metro_bus/stops.txt"
if path.exists(gtfs_stopsfile):
    try:
        with open("metro_bus/stops.txt") as stopsfile:
...
gtfs_calendarfile="metro_bus/calendar.txt"
...
gtfs_calendar_datesfile="metro_bus/calendar_dates.txt"
...
try:
    with open("metro_bus/t-time.css","r") as cssfile:
        for line in cssfile:
            css+=line
    css+="</style>"
except BaseException as ex:
